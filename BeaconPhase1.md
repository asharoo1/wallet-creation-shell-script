...
**Note:** **`After successfully completing the above instructions, you can now move on to` [Service Creation configuration and Deployment using Cloudformation Templates.](https://github.com/)**
